...
type (
	...
	ISysAedsLocation interface {
		// Model AED定位ORM模型
		Model(ctx context.Context, option ...*handler.Option) *gdb.Model
		// List 获取AED定位列表
		List(ctx context.Context, in *sysin.AedsLocationListInp) (list []*sysin.AedsLocationListModel, totalCount int, err error)
		// Export 导出AED定位
		Export(ctx context.Context, in *sysin.AedsLocationListInp) (err error)
		// Edit 修改/新增AED定位
		Edit(ctx context.Context, in *sysin.AedsLocationEditInp) (err error)
		// Delete 删除AED定位
		Delete(ctx context.Context, in *sysin.AedsLocationDeleteInp) (err error)
		// View 获取AED定位指定信息
		View(ctx context.Context, in *sysin.AedsLocationViewInp) (res *sysin.AedsLocationViewModel, err error)
	}
...
var (
	...
	localSysAedsLocation   ISysAedsLocation
...
func SysAedsLocation() ISysAedsLocation {
	if localSysAedsLocation == nil {
		panic("implement not found for interface ISysAedsLocation, forgot register?")
	}
	return localSysAedsLocation
}

func RegisterSysAedsLocation(i ISysAedsLocation) {
	localSysAedsLocation = i
}
